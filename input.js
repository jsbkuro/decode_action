...
(global.webpackJsonp = global.webpackJsonp || []).push([ [ "pages/user/user" ], {
    "07e5": function(t, e, n) {
        (function(t) {
            ...
            n("6cdc"), n("921b"), e(n("66fd")), t(e(n("33a9")).default);
        }).call(this, n("543d").createPage);
    },
    "15e3": function(t, e, n) {
        n.r(e);
        var r = n("41af"), o = n.n(r);
    ...
    "41af": function(e, n, r) {
        (function(e) {
            ...
            var o = p(r("2686")), i = r("365c"), a = p(r("131c")), u = r("aaf5"), c = p(r("bee3")), s = r("2f62"), f = p(r("eea7")), l = p(r("b775"));
            function p(t) {
                return t && t.__esModule ? t : {
                    default: t
                };
            ...
            function d() {
                ...
                function f(t, e, n, r) {
                    var i = e && e.prototype instanceof m ? e : m, a = Object.create(i.prototype), u = new B(r || []);
                    return o(a, "_invoke", {
                        value: S(t, n, u)
                    }), a;
                }
                ...
                e.wrap = f;
                var p = "suspendedStart", g = "executing", v = "completed", y = {};
                function m() {}
                function b() {}
                function w() {}
                var _ = {};
                ...
                var x = Object.getPrototypeOf, P = x && x(x(M([])));
                ...
                function S(e, n, r) {
                    ...
                    return function(i, a) {
                        ...
                        for (r.method = i, r.arg = a; ;) {
                            ...
                            var s = l(e, n, r);
                            if ("normal" === s.type) {
                                if (o = r.done ? v : "suspendedYield", s.arg === y) continue;
                                return {
                                    value: s.arg,
                                    done: r.done
                                };
                ...
                function k(e, n) {
                    ...
                    n.arg = t, k(e, n), "throw" === n.method) || "return" !== r && (n.method = "throw", 
                    ...
                    n.arg = t), n.delegate = null, y) : a : (n.method = "throw", n.arg = new TypeError("iterator result is not an object"), 
                    n.delegate = null, y);
                }
                function E(t) {
                    var e = {
                ...
                return b.prototype = w, o(O, "constructor", {
                    value: w,
                    configurable: !0
                }), o(w, "constructor", {
                    value: b,
                    configurable: !0
                }), b.displayName = s(w, c, "GeneratorFunction"), e.isGeneratorFunction = function(t) {
                    var e = "function" == typeof t && t.constructor;
                    return !!e && (e === b || "GeneratorFunction" === (e.displayName || e.name));
                }, e.mark = function(t) {
                    return Object.setPrototypeOf ? Object.setPrototypeOf(t, w) : (t.__proto__ = w, s(t, c, "GeneratorFunction")), 
                    t.prototype = Object.create(O), t;
                }, e.awrap = function(t) {
                    return {
                        __await: t
                    };
                }, j(L.prototype), s(L.prototype, u, function() {
                    return this;
                ...
                }, j(O), s(O, c, "Generator"), s(O, a, function() {
                    return this;
                    ...
                    dispatchException: function(e) {
                        ...
                        var n = this;
                        function o(r, o) {
                            return u.type = "throw", u.arg = e, n.next = r, o && (n.method = "next", n.arg = t), 
                            !!o;
                        }
            ...
            n.default = m(m({}, o.default), {}, {
                ...
                onLoad: function() {
                    this.isProd = !!l.default.isProd, this.randomBackground();
                },
                onShow: function() {
                    this.getSpecialScreen(), this.getJsonUserConfig(), this.is_login && this.$refs.userHeader.showShakeAni(), 
                ...
                methods: {
                        ...
                        return v(d().mark(function e() {
                            ...
                            return d().wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                  case 0:
                                    return e.next = 2, (0, i.jsonUserConfig)();

                                  case 2:
                                    n = e.sent, r = n.data, t.user_config = null != r ? r : {}, t.user_info = t.globalUser || r.user_info, 
                    ...
                    getProperty: function() {
                        ...
                        Promise.all([ (0, i.goPopBadgeNum)(), (0, i.pyUserQuantity)(), a.default.goGetBoxCouponList({
                            ...
                            t.userBadges = e[0].data.data, e[1].data.data.coupon_count += e[2].data.data.total, 
                            t.userQuantity = e[1].data.data, t.$nextTick(function() {
                                return t.initComponents();
                            });
                        });
                    },
                    initComponents: function() {
                        for (var t in this.$refs) this.$refs[t].init && this.$refs[t].init();
                        e.stopPullDownRefresh();
                    },
                    toPage: function(t) {
                        var n = t.config, r = t.notice, o = t.track, i = void 0 === o ? null : o;
                        this.is_login ? (i && c.default.track(i.name, m({}, i.data)), r && r.message ? this.watchSubscribeMessage(n, r) : (0, 
                        u.jumpPage)(n)) : n.hasOwnProperty("need_login") && 0 == n.need_login ? (0, u.jumpPage)(n) : e.navigateTo({
                    ...
                    watchSubscribeMessage: function(t, e) {
                        ...
                        return v(d().mark(function e() {
                            ...
                            return d().wrap(function(e) {
                                for (;;) switch (e.prev = e.next) {
                                  case 0:
                                    return "rule_my_page_coupon_expiration", r = "SF2EgJqSm2ls-hmDx-z3YZom0JkQIT08jDl1Z4nGNqY", 
                                    e.prev = 2, e.next = 5, (0, i.goNewQueryMsgSub)({
                                  ...
                                  case 5:
                                    ...
                                    return (0, u.jumpPage)(t), e.abrupt("return");

                                  case 10:
                                    n.subscribeMessage(t, [ r ]), e.next = 16;
                                    break;

                                  case 13:
                                    e.prev = 13, e.t0 = e.catch(2), (0, u.jumpPage)(t);
                ...
                watch: {
                    globalUser: function(t) {
                        this.user_info = Object.assign({}, m({}, t)), this.$forceUpdate();
                    }
                }
            });
